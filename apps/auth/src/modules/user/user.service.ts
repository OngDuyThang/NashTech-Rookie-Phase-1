...
export class UserService {
  ...
  async findOne(usernameOrEmail: string): Promise<UserEntity> {
    try {
  ...
  async enableTwoFactor(id: string): Promise<TEnableTwoFactorResponse> {
  ...
  async updateOneTimeToken(id: string, token: string | null): Promise<void> {
    await this.userRepository.update(
      { id },
      {
  ...
  async validateExistEmail(email: string): Promise<UserEntity | null> {
    try {
